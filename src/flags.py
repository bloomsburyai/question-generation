...
tf.app.flags.DEFINE_integer("max_context_len", 768, "Max context length. 768 for squad")
tf.app.flags.DEFINE_integer("max_copy_size", 768, "Max size of copy vocab to limit output distribution. 768 or 322")
